/*
  ...
  - Added the required column `isPending` to the `Club` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Club" ("channel", "id", "name", "serverId", "topics") SELECT "channel", "id", "name", "serverId", "topics" FROM "Club";
DROP TABLE "Club";
